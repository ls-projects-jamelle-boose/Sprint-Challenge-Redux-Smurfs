...
- Application state is global and component state is local. Redux uses the store to hold application state, any component in the app can access it as long as they connect to it. The component state can only be updated w/in that specific component and passed down to its children thru props.
